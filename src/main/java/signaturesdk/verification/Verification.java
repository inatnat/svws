...
public class Verification {
	 ...
	 */
	public static Vector<Double> coordsDTW(LinkedList<SignWord> origSign, LinkedList<SignWord> testSign, boolean merged) {
	 ...
	 * @return
	 */
	public static Vector<Double> criticalPointsDTW(LinkedList<SignWord> origSign, LinkedList<SignWord> testSign, boolean merged) {
		if(origSign.size() == 0 || testSign.size() == 0)
			return null;
