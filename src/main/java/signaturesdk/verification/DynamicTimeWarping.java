...
//			System.out.println("");
//			for (int j = 0; j< this.numCols; j++) {
//				System.out.print(MathUtil.roundToNDigits(distanceMatrix[i][j], 1) + ",");
//			}
//		}
...
//		System.out.println("DTWMatrix");
//		for (int i=0; i< this.DTWMatrix.length; i++ ) {
//			System.out.println("");
//			for (int j = 0; j< this.DTWMatrix[0].length; j++) {
//				System.out.print(MathUtil.roundToNDigits(distanceMatrix[i][j], 1) + ",");
//			}
//		}
