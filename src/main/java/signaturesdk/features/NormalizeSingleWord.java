 ...
 *
 */
public class NormalizeSingleWord {
	int minDistance1;
	...
	public int getMinDistance1() {
		return minDistance1;
	}

	public void setMinDistance1(int minDistance1) {
		this.minDistance1 = minDistance1;
	}
	 ...
	 */
	public NormalizeSingleWord(LinkedList<AcquisitionSignWord> signature) {
	 ...
	 * @param signature the signature to normalize
	 */
	public NormalizeSingleWord(LinkedList<AcquisitionSignWord> signature, int minDistance) {
		this.words = signature;
		this.minDistance1 = minDistance;
	}
